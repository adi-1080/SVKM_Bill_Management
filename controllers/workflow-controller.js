    ...
    for (const billId of billIds) {
      try {
        ...
        if (
          ...
          else if (toRole == "site_dispatch_team") {
        ...
        // PIMO Mumbai to Trustees
          ...
          action == "forward"
            ...
            else if(toRole=="pimo_dispatch_team"){
